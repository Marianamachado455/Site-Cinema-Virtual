document.addEventListener('DOMContentLoaded', function() {
  ...
  const filmesCompletos = {
    ...
    3:  { id: 3,  genero: "acao",     titulo: "Mad Max",        idade: "14", poster: "Imagens/postermadmax.jpg" },
    4:  { id: 4,  genero: "acao",     titulo: "John Wick",      idade: "16", poster: "Imagens/poster_jhonwick.jpg" },
    5:  { id: 5,  genero: "comedia",  titulo: "A Grande Viagem",idade: "L",  poster: "Imagens/poster2.jpeg" },
    6:  { id: 6,  genero: "comedia",  titulo: "Se Beber Não Case", idade: "14", poster: "Imagens/poster_Sebebernaocase.jpg" },
    7:  { id: 7,  genero: "comedia",  titulo: "Deadpool",       idade: "16", poster: "Imagens/poster_deadpool.webp" },
 ...
 confirmarBtn.addEventListener('click', () => {
    ...
    // Salva total e filme no localStorage
    const total = assentosSelecionados.size * VALOR_UNITARIO;
    localStorage.setItem('totalIngressos', total.toFixed(2));
